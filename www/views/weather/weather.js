angular.module('App')
.controller('WeatherController', function ($scope, $http, $stateParams, $ionicActionSheet, $ionicModal, Locations, Settings, $ionicLoading) {
...
/*
  ...
  */
  // modified my function using Dr. Babb's example to fix what I had wrong
  ...
  .error(function(err){
    $ionicLoading.show({
      template: 'Problem loading weather.',
      duration: 3000
    });
  })
  .finally(function() {
